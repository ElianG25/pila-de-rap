...
export default function EventView({
  ...
  return (
    ...
    >
      <div className={`${cardBase} border-yellow-400/20 p-5 md:p-7`}>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                  ...
                  >
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      <div className={`${statCard} px-3 py-3`}>
                        ...
                        <p className="mt-1 text-xs sm:text-sm font-black text-white leading-tight">
                      ...
                      <div className={`${statCard} px-3 py-3`}>
                        ...
                        <p
                          className={`mt-1 text-xs sm:text-sm font-black ${isLiveEvent
                            ? "text-green-300"
                            : isPostEvent
                              ? "text-gray-300"
                              : "text-yellow-300"
                        ...
                        >
                          {isPostEvent ? "Finalizada" : isLiveEvent ? "En vivo" : "Próxima"}
                        </p>
                      </div>
                ...
                {isPostEvent && (
                  <div className={`${cardBase} mt-5 border-yellow-400/20 p-5`}>
                    ...
                    <div className="mt-6 grid gap-3">
                      {[
                        { label: "Campeón", value: championAlias || "Pendiente", highlight: true },
                        { label: "Subcampeón", value: runnerUpAlias || "Pendiente", highlight: false },
                        { label: "3er lugar", value: thirdPlaceAlias || "Pendiente", highlight: false },
                      ].map((item) => (
                        <div
                          key={item.label}
                        ...
                        >
                          ...
                          <p className="mt-1 text-xl font-black text-white leading-tight break-words">
                            {item.value}
                          </p>
                        </div>
                      ))}
                    ...
                    {eventConfig.nextEventLabel && (
                      <div className="mt-5 rounded-2xl border border-white/10 bg-black/40 p-4 text-center">
                        ...
                        <p className="mt-1 text-lg font-black text-yellow-300 leading-tight">
                          {eventConfig.nextEventLabel}
                        </p>
                      </div>
                    )}
                ...
                {/* JUECES */}
                <div className={`${softCard} mt-6 mb-6 px-4 py-3`}>
                  <p className={`text-center ${mutedEyebrow}`}>
                    Jueces
                  </p>
                      ...
                      <div key={juez.nombre} className="flex items-center gap-3">
                        {juez.ig ? (
                          <a
                            ...
                            className="text-xs font-black text-yellow-300 hover:text-yellow-200 transition"
                          >
                            {juez.nombre}
                          </a>
                        ) : (
                ...
                <div className={`${softCard} mb-6 p-3`}>
                  <div className="mb-3 flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-xs font-bold text-gray-300 leading-tight">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="shrink-0 rounded-full border border-yellow-400/20 bg-yellow-400/10 px-3 py-2 text-[10px] font-black uppercase tracking-wide text-yellow-300 hover:bg-yellow-400 hover:text-black transition"
                    >
                      Abrir
                    </a>
                  </div>
                    ...
                    >
                      ...
                      <div className="mt-3 h-2 w-full overflow-hidden rounded-full border border-yellow-400/10 bg-black/60">
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{
                            width: `${Math.min(100, Math.max(0, ((32 - slots) / 32) * 100))}%`,
                          }}
                  ...
                  {events.length > 0 && (
                    <div className="mt-6 rounded-3xl border border-white/10 bg-black/35 p-4 backdrop-blur">
                      ...
                      <div className="relative space-y-4">
                        <div className="absolute left-[17px] top-2 bottom-2 w-px bg-yellow-400/15" />

                        {events.map((eventItem, index) => {
                          const status = String(eventItem.estado || "").trim().toLowerCase();
                          const isFinished = status === "finalizada";
                          const isNext = status === "próxima" || status === "proxima";
                              ...
                              >
                                <div className="flex items-start justify-between gap-3">
                                  <div className="min-w-0">
                                    <p className="font-black text-white leading-tight break-words">
                                      {eventItem.fecha}
                                    </p>
                                ...
                                {isFinished && (
                                  <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                                    <div className="rounded-xl border border-yellow-400/10 bg-black/30 px-3 py-2">
                                      ...
                                      <p className="mt-1 text-sm font-black text-yellow-300 leading-tight break-words">
                                    ...
                                    <div className="rounded-xl border border-white/10 bg-black/30 px-3 py-2">
                                      ...
                                      <p className="mt-1 text-sm font-black text-white leading-tight break-words">
